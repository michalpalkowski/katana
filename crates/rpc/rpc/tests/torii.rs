...
//             // The declare transaction has completed, but we don't need to do anything with it
// here.             result.expect("Should succeed");
//         }
//     }
...
//     TransactionWaiter::new(deploy_txn_future.transaction_hash,
// &account.provider()).await.unwrap();
